            ...
            if(inputMode == PAIRED_MODE) //for paired end reads
            {
                ...
                while(fgets(readLine, MAX_LINE_LEN, finRead) != NULL) //read the read header
                {
                    ...
                    else if(splitMode == HALF_SPLIT_MODE) //collapse each mate in halves
                    {
                        ...
                        AssignHalfSplitComplementsAndDirections(readLine, compReadLine, inputReadLength, strandSwitchedFLAG_firstSplit, strandSwitchedFLAG_secondSplit);
                    ...
                    else if(splitMode == THREEWAY_SPLIT_MODE) //collapse each mate in thirds
                    {
                        ...
                        AssignThirdSplitComplementsAndDirections(readLine, compReadLine, inputReadLength, strandSwitchedFLAG_firstSplit, strandSwitchedFLAG_secondSplit, strandSwitchedFLAG_thirdSplit);
                        ...
                        else
                        {
                            ...
                            ptr = &(collapsed[compReadLine + oneThirdReadLength]);
                    ...
                    else if(splitMode == HALF_SPLIT_MODE)
                    {
                        ...
                        bool strandSwitchedFLAG_firstSplit = 0, strandSwitchedFLAG_secondSplit = 0;
                        AssignHalfSplitComplementsAndDirections(readLine_mate, compReadLine_mate, inputReadLength, strandSwitchedFLAG_firstSplit, strandSwitchedFLAG_secondSplit);
                        hashItem **ptr;
                        if(strandSwitchedFLAG_firstSplit == 0)
                        {
                    ...
                    {
                        bool strandSwitchedFLAG_firstSplit = 0, strandSwitchedFLAG_secondSplit = 0, strandSwitchedFLAG_thirdSplit = 0;
                        AssignThirdSplitComplementsAndDirections(readLine_mate, compReadLine_mate, inputReadLength, strandSwitchedFLAG_firstSplit, strandSwitchedFLAG_secondSplit, strandSwitchedFLAG_thirdSplit);
                        ...
                        else
                        {
                            ...
                            ptr = &(collapsed[compReadLine_mate + oneThirdReadLength]);
